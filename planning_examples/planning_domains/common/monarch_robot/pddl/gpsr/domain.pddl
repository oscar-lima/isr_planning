(define (domain gpsr)
  ...
  (:action grasp
    ...
    :precondition (and (at_r ?l) (on ?obj ?l) (gripper_empty))
  ...
  (:action introduce
    :parameters (?p - person ?l - location)
    :precondition (and (at_p ?p ?l) (at_r ?l) (found ?p))
  ...
  (:action guide
    ...
    :precondition (and (at_p ?p ?source) (at_r ?source) (found ?p))
  ...
  (:action answer_question
    :parameters (?p - person ?l - location)
    :precondition (and (puzzled ?p) (at_p ?p ?l) (at_r ?l) (found ?p))
