...
function show_help_and_exit(){
    ...
    echo './mercury'
    echo '/home/user/...my_path.../common/pddl/example_domain/domain.pddl'
    echo '/home/user/...my_path.../common/pddl/example_domain/problems/p1.pddl'
    echo '/home/user/...my_path.../src/isr_planning/mercury_planner/build/Mercury-fixed/seq-sat-mercury'
    echo '10.0'
    echo 'false'
    echo '2'
    echo '3'
