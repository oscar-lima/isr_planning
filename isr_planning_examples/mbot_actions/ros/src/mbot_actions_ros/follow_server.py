...
from mbot_action_msgs.msg import FollowAction, FollowFeedback, FollowResult
...
def start_follow_server():
    # Construct state machine
    sm = smach.StateMachine(
            outcomes=['OVERALL_SUCCESS','OVERALL_FAILED','OVERALL_PREEMPTED'],
            input_keys = ['follow_goal'],
            output_keys = ['follow_feedback', 'follow_result'])
    with sm:        
