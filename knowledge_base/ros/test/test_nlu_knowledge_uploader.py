...
"""
Test unit for the functions used in nlu_knowledge_uploader.py
"""
...
import knowledge_base_ros.nlu_knowledge_uploader

PKG = 'mbot_nlu'

class NLUKnowledgeUploaderTest(unittest.TestCase):
    def setUp(self):
        '''
...
if __name__ == '__main__':
    rospy.init_node('mbot_nlu_test')
    knowledge_base_ros.nlu_knowledge_uploader.main()
