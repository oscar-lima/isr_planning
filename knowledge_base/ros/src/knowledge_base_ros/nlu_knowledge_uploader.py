...
class nlu_knowledge_upload(object):
    def __init__(self):
        ...
        self.slot_to_type = {'summer': 'p', 'madison': 'p', 'freddie': 'p', 'bananas': 'obj', 'office': 'l',
                                    ...
                                    'sofa': 'l', 'dinning table': 'l', 'cider': 'obj', 'alice': 'p', 'candy': 'obj',
                                    ...
                                    'living room': 'l', 'rum': 'obj', 'harry': 'p', 'lotion': 'obj',
                                    ...
                                    'bookshelf':'l', 'coffee table':'l', 'sidetable':'l', 'dinning room':'l',
                                    'dinning room':'l', 'kitchen table':'l', 'kitchen cabinet':'l', 'rice':'obj',
                                    'kleenex':'obj', 'whiteboard cleaner':'obj', 'cup':'obj', 'drink':'obj', 'food':'obj',
                                    'cleaning stuff':'obj', 'mia':'p', 'liam':'p', 'sophia':'p', 'abigail':'p',
